                                    ...
                                    <div className=' relative inline-flex flex-wrap align-text-top w-full'>
                                        ...
                                        <div className=' min-w-0 text-[1rem] font-normal fill-current p-0 w-full items-center gap-[2px] relative text-left z-0 flex'>
                                            ...
                                            <label htmlFor='firstName'
                                                className={`placeLabel ${formik.values.firstName ? 'hasText' : '' // Add 'hasText' class if there's text in the input
                                                    }`}> Firstname
                                            </label>
                                        </div>
                                    ...
                                    <div className=' relative inline-flex flex-wrap align-text-top w-full'>
                                        ...
                                        <div className=' min-w-0 text-[1rem] font-normal fill-current p-0 w-full items-center gap-[2px] relative text-left z-0 flex'>
                                            ...
                                            <label htmlFor='lastName'
                                                className={`placeLabel ${formik.values.lastName ? 'hasText' : '' // Add 'hasText' class if there's text in the input
                                                    }`}> Lastname
                                            </label>
                                        </div>
                                ...
                                <li className=' list-none ml-0 mb-[10px]'>
                                    <div className=' relative inline-flex flex-wrap align-text-top w-full'>
                                        ...
                                        <div className=' min-w-0 text-[1rem] font-normal fill-current p-0 w-full items-center gap-[2px] relative text-left z-0 flex'>
                                            ...
                                            />
                                            <label htmlFor='email'
                                                className={`placeLabel ${formik.values.email ? 'hasText' : '' // Add 'hasText' class if there's text in the input
                                                    }`}> Email
                                            </label>
                                        </div>
                                    ...
                                    <div className=' relative inline-flex flex-wrap align-text-top w-full'>
                                        ...
                                        <div className=' min-w-0 text-[1rem] font-normal fill-current p-0 w-full items-center gap-[2px] relative text-left z-0 flex'>
                                            ...
                                            <label htmlFor='password'
                                                className={`placeLabel ${formik.values.password ? 'hasText' : '' // Add 'hasText' class if there's text in the input
                                                    }`}> Add a password
                                            </label>
                                        </div>
